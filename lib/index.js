...
function levelUp () {
  ...
  document.querySelector('.level-value-screen').innerText = level;
  document.querySelector('.new-level-button-text').innerText = level;
}
...
function gameOver () {
  ...
  if (oldHighScore.score < score) {
    ...
    document.querySelector('.game-over-high-score').innerText = score;
    newHighScoreScreen.classList.toggle('hidden');
  } else {
    gameOverScreen.classList.toggle('hidden');
    document.querySelector('.game-over-score').innerText = score;
  }
}
