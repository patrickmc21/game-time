...
let gamePause = false;
let gunSound = new Sound('../sounds/Laser_Shoot1.wav')
let spiderSound = new Sound('../sounds/Emerge11.wav')
let generateCentipedeSound = new Sound('../sounds/Explosion1.wav')
let gameOverSound = new Sound('../sounds/Shut_Down1.wav')
let centipedeHitSound = new Sound('../sounds/Explosion2.wav')
let collisionSound = new Sound('../sounds/Explosion6.wav');
